...
def main(url, model_url, config_url, video_name):
    ...
    logger.info("[5/9] Creating original voice references per each translated `phrase`...")
    ...
    logger.info("[6/9] Loading StyleTTS2 checkpoint...")
    ...
    logger.info("[7/9] Generating translated speech...")
    ...
    logger.info("[8/9] Merging translated speech samples into the final audio file...")
    ...
    logger.info("[9/9] Exporting AI dubbed video...")
